  ...
  return (
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className="mt-4 lg:max-w-lg info-text">Embark on a shopping journey tha redefines your experience with unbeatble deals. From premier selections to incredible savings, we offer unparalled value that sets us apart.</p>
